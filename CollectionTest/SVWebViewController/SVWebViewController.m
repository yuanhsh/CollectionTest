...
- (id)initWithURL:(NSURL*)pageURL delegate:(id<UIWebViewDelegate>)webdelegate {
    if(self = [super init]) {
        self.URL = pageURL;
...
- (UIToolbar *)toolbar {
    if (!_toolbar) {
        _toolbar = [[UIToolbar alloc] initWithFrame:CGRectMake(0.0f, CGRectGetHeight(self.view.frame)-44.0f, CGRectGetWidth(self.view.frame), 44.0f)];
